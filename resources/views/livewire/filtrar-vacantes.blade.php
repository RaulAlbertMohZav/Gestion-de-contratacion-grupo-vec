            ...
            <div class="md:grid md:grid-cols-3 gap-5">
                <div class="mb-5">
                    ...
                    <input
                        id="termino"
                        type="text"
                        placeholder="Buscar por Término: ej. Ingeniero en software"
                ...
                <div class="mb-5">
                    <label class="block mb-1 text-sm text-gray-700 uppercase font-bold">Salario Mensual Estimado</label>
